...
const STEPS: Step[] = [
  ...
  { route: "/recommendations", target: "[data-tour='plan-item']", navTarget: "[data-tour='nav-plan']", title: "Your plan lives here", body: "Tap Plan in the menu and you land here, your top money moves for the month. Each card is one pick, like this. If your plan is still cooking, a sample card holds the spot.", mood: "proud" },
