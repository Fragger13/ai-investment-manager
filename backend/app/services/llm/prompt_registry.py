...
def chat_prompt(message: str, context: dict[str, Any], fallback_answer: str) -> str:
    ...
    return (
        ...
        "  NEVER open two replies in a row the same way — check your last reply in the conversation; "
        "  on a follow-up, skip the greeting entirely and answer directly.\n"
        ...
        "- Use dad-style turns of phrase: 'in that order', 'theek hai', "
        ...
        "- Vague commands like 'pick one' or 'do this' when you haven't just listed named options. "
        "  Name the exact action instead ('start the Rs 18,000 monthly transfer').\n"
        "- Em dashes and long dashes. Use commas, full stops, or the word 'to' for ranges.\n\n"
        "GROUNDING RULES:\n"
        ...
        "- Currency is INR with INDIAN digit grouping: Rs 2,34,000 and Rs 1,50,414 — never Rs 234,000. "
        "  Lakhs and crores are welcome (Rs 2.3 lakh).\n\n"
